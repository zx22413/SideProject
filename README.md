...
│   ├── 當前專案_靈魂食堂/
│   │   └── README.md         # 專案總覽（新手必讀）
│   ├── 開發決策鏈.md          # V1.0 → V4.0 的決策邏輯
│   └── 歷史歸檔_V1.0-V1.3/   # 舊版企劃（Cloudy 時代）
│
├── 01-開發實驗/              # 程式碼與技術文件
│   ├── 程式碼/
...
│
├── 02-劇本設計/              # 劇本與敘事設計
│   ├── Guest1_失憶老裁縫_完整劇本.md  ✅ 可直接使用
│   └── 靈魂考古_3日邏輯鏈.md   # 敘事結構藍圖
│
├── 02-研究分析/              # 競品分析與理論研究
...
│
└── 00-工作區/                # 進度管理與報告
    ├── 主 Backlog_2026-01-15.md         # 任務清單
    ├── 重構完成報告_2026-01-17.md       ✅ 最新進度
    └── 架構診斷報告_2026-01-15.md       # 診斷依據
```
...
**必讀順序**：
1. 📖 [當前專案 README](00-核心企劃/當前專案_靈魂食堂/README.md) - 理解專案背景與核心概念
2. 🎭 [靈魂食堂：最終開發執行企劃書](靈魂食堂：最終開發執行企劃書.md) - 完整世界觀與機制
3. 📜 [Guest1 完整劇本](02-劇本設計/Guest1_失憶老裁縫_完整劇本.md) - 看實際範例

### 👨‍💻 開發者快速上手

**部署流程**：
1. 閱讀 [程式碼 README](01-開發實驗/程式碼/README.md)
2. 複製 `程式碼_GAS相容版.gs` 到 Google Apps Script
3. 設定 Google Sheets（參考 [專案實作對照表](01-開發實驗/專案實作對照表.md)）
4. 填入劇本到 `dialogueLibrary`
...
2. 參考 [Guest1 完整劇本](02-劇本設計/Guest1_失憶老裁縫_完整劇本.md) 的結構
3. 設計角色的「執念」與「目標料理」
4. 建立標籤系統與分支對話
...
**userState Sheet（10 欄）**：
- userId, currentDay, guestID, collectedTags, lastActive
- unlockedRecipe, phase, inventory, completedGuests, lifetimeHeirlooms

**dialogueLibrary Sheet（5 欄）**：
...
### 給新手
- 📖 [當前專案 README](00-核心企劃/當前專案_靈魂食堂/README.md)
- 🎭 [靈魂食堂：最終開發執行企劃書](靈魂食堂：最終開發執行企劃書.md)
- 📜 [Guest1 完整劇本](02-劇本設計/Guest1_失憶老裁縫_完整劇本.md)

### 給開發者
- 💻 [程式碼 README](01-開發實驗/程式碼/README.md)
- 📋 [專案實作對照表](01-開發實驗/專案實作對照表.md)
- 🐛 [重構完成報告](00-工作區/重構完成報告_2026-01-17.md)
...
- 📊 [最新工作報告](00-工作區/工作報告_2026-01-22_UX全面改進.md)
