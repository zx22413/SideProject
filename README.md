...
│   │   └── archive-versions/                # 重構版、畫鬼腳等歷史版
│   └── 專案實作對照表.md      # 技術規格手冊
│
├── 02-劇本設計/              # 劇本與敘事設計
│   ├── Guest1_田中太郎_重構版_神秘感優先.md  ⭐ 當前劇本（V4.4）
│   ├── 田中太郎_人生紀實.md
│   ├── 田中太郎_人生紀實整合建議.md
│   ├── 田中太郎劇情流程圖.md
│   ├── 靈魂考古_3日邏輯鏈.md
...
└── 00-工作區/                # 進度管理與報告
    ...
    ├── 工作報告_2026-01-23_Day2-3動態系統完成.md  ⭐ 最新
    └── archive-2026-01/                       # 架構診斷、重構報告等歸檔
```

**說明**：以上以 2026-01-24 實際目錄為準。歷史版本與舊報告見各 `archive-versions`、`archive-2026-01`。
...
- 📊 [最新工作報告](00-工作區/工作報告_2026-01-23_Day2-3動態系統完成.md)
